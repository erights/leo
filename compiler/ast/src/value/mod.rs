...
impl Value {
    ...
    pub fn from_u128(type_: Type, value: u128) -> Self {
        // Should never error since we converted from a start..stop and then back.
        match type_ {
            Type::U8 => Value::U8(value.try_into().unwrap()),
            Type::U16 => Value::U16(value.try_into().unwrap()),
            Type::U32 => Value::U32(value.try_into().unwrap()),
            Type::U64 => Value::U64(value.try_into().unwrap()),
            Type::U128 => Value::U128(value),
            Type::I8 => Value::I8(value.try_into().unwrap()),
            Type::I16 => Value::I16(value.try_into().unwrap()),
            Type::I32 => Value::I32(value.try_into().unwrap()),
            Type::I64 => Value::I64(value.try_into().unwrap()),
            Type::I128 => Value::I128(value.try_into().unwrap()),
            _ => unreachable!(),
        }
    }
